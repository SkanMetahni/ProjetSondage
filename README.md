...
UI (User Interface) : Une interface moderne basée sur shinydashboard avec des menus intuitifs.
Server : Une logique backend robuste gérant les calculs statistiques complexes, la manipulation de dataframes volumineux et la génération de rapports.
